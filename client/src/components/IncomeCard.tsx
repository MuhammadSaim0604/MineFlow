    ...
    <Card className="p-6 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4 pt-4 border-t border-border">
        <div className="space-y-1">
          ...
          <div className="text-lg font-mono font-semibold text-chart-2 flex items-center gap-1" data-testid="text-session-earnings">
      ...
      {percentageChange !== 0 && (
        <div className={`text-sm font-medium ${percentageChange > 0 ? "text-chart-2" : "text-destructive"}`}>
