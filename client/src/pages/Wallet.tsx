...
export default function Wallet() {
  ...
  const getColor = (type: string) => {
    if (type === "transfer_send" || type === "withdrawal") return "text-chart-3 bg-chart-3/10";
    if (type === "transfer_receive" || type === "deposit") return "text-chart-2 bg-chart-2/10";
        ...
        <div className="space-y-2">
          ...
          {showBalance && (
            <p className="text-sm text-muted-foreground">
              ≈ ${(parseFloat(balance) * 65000).toFixed(2)} USD
            </p>
          )}
        </div>
      </Card>
                  ...
                  >
                    ...
                    <div className="text-right">
                      <div className={`text-sm font-mono font-semibold ${
                        isNegative(tx.type, tx.amount) ? "text-chart-3" : "text-chart-2"
                      }`}>
